...
class Scoreboard:
	...
	def __init__(self, ai_game):
		...
		self.text_colour = (255, 225, 255)
		self.hs_colour = (200, 200, 0)
	...
	def prep_high_score(self):
		...
		# Place the high score at the right of the screen.
	...
	def prep_ships(self):
		...
		for ship_number in range(self.stats.ships_left):
			ship = Lives(self.ai_game)
			ship.rect.x = 10 + ship_number * ship.rect.width
			ship.rect.y = self.screen_rect.bottom - ship.rect.height
			self.ships.add(ship)

	def show_score(self):
		"""Draw scores, lives and level to the screen."""
